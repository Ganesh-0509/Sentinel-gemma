# Sentinel-Gemma — Demo Video Script
...
> "In a steel plant, the gap between a gas reading drifting and a worker getting hurt is measured in minutes. Most systems tell you after the alarm trips. Sentinel-Gemma tells you before."
...
> "Real plant geometry. Live sensor fusion. Vision-based worker awareness. Regulation-grounded decisions that can't be overridden by a model. That's Sentinel-Gemma — it shortens the gap between drift and harm."
