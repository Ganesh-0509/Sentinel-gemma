...
def aggregate(results: list[dict]) -> dict:
    ...
    # the killer stat: incidents baseline missed but Sentinel-Gemma caught
...
def scoreboard_text(agg: dict) -> str:
    ...
    lines = [
        ...
        "-" * 66,
        f"  {'metric':<34}{'baseline':>14}{'Sentinel-Gemma':>14}",
        "-" * 66,
        ...
        "-" * 66,
        f"  >> Incidents the baseline MISSED that Sentinel-Gemma caught: "
