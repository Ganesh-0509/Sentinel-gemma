...
The Sentinel-Gemma database is designed to store industrial operational data, AI predictions, maintenance activities, permit records, incident history, user information, and regulatory documents.
