...
export const Route = createFileRoute("/digital-twin")({
  head: () => ({
    meta: [
      { title: "Plant Digital Twin · Sentinel-Gemma" },
      {
        name: "description",
        content:
          "Interactive 3D plant map with per-zone risk, gas, pressure, temperature and worker context, streamed live from the Sentinel-Gemma backend.",
      },
    ],
  }),
