...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Operations Overview · Sentinel-Gemma" },
      {
        name: "description",
        content:
          "Live compound risk across the plant — zone telemetry, prioritised alerts and SHAP explanations from the Sentinel-Gemma backend.",
      },
    ],
  }),
  component: Dashboard,
